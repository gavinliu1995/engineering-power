...
**Note:** Tell your human partner that Superpowers works much better with access to subagents. The quality of its work will be significantly higher if run on a platform with subagent support (Claude Code, Codex CLI, Codex App, and Copilot CLI all qualify; see the per-platform tool refs in `../using-engineering-power/references/`). If subagents are available, use subagent-driven-development instead of this skill.
...
- **REQUIRED SUB-SKILL:** Use finishing-development-work
...
- **finishing-development-work** - Complete development after all tasks
